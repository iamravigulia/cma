...
<div class="border border-gray-500 rounded-xl m-8 p-8 bg-white">
    <form action="{{route('fmt.cma.store')}}" method="post" class="fmt_box">
        <div class="fmt_headline">Add a MCA</div>
        ...
        {{-- <div class="my-2">
            <div class="flex flex-wrap -mx-2">
                ...
                <div class="w-1/3 px-2">
                    <label class="w-full" for="">Score</label>
                    <input class="my-2 border border-gray-500 p-2 w-full rounded-lg" type="integer" name="question_score" placeholder="Score" required>
                </div>
                <div class="w-1/3 px-2">
        ...
        <div>
            <input type="submit" class="block py-2 px-8 bg-blue-600 text-white text-uppercase rounded-lg" value="Submit">
        </div>
    </form>
    <script>
